...
<head>
    ...
    <title>Detalles huevos doble yema</title>
</head>
<body>
...
<form class="detalle">
    ...
    <div class="productoaaa">
        <img src="/mvc-hj/img/productos/dobleYema.jpg">
    </div>

    <div class="descripcion">

        <h2>Huevos doble yema</h2>
        <p class="descripciontexto">
            - Estos huevos se destacan por tener dos yemas en su interior.<br>
            - Son de color beige. <br>
            - Los mas pedidos por la clientela. <br>
