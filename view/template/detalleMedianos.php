...
<head>
    ...
    <title>Detalles Huevos medianos</title>
</head>
<body>
...
<form class="detalle">
    ...
    <div class="productoaaa">
        <img src="/mvc-hj/img/productos/medianos.jpg">
    </div>

    <div class="descripcion">

        <h2>Huevos medianos</h2>
        <p class="descripciontexto">
            - Estos huevos se destacan tener un tamaño mediano, un poco mas pequeño que el triple A y el doble yema.<br>
            - Son de color blanco y beige. <br>
            - Los mas accesiles segun la clientela. <br>
